...
<?php foreach($itemtype_list as $itemtype) { ?>
<tr>
<td><?php echo $itemtype['itemId']; ?></td>
<td><?php echo $itemtype['itemName']; ?></td>
<td><?php echo $itemtype['itemDesc']; ?></td>
<td><?php echo $itemtype['itemValidTime']/(3600*24); ?> ngày</td>
<td><?php echo $itemtype['price']; ?></td>
<td><?php echo $itemtype['FBPrice']; ?></td>
<td><?php echo $itemtype['YFBPrice']; ?></td>
<td><?php echo $itemtype['exp']; ?></td>
<td><?php echo $itemtype['level']; ?></td>
<td>
<a href="admin.php?mod=itemtype_edit&id=<?php echo $itemtype['itemId']; ?>">Sửa</a>
</td>
</tr>
<?php } ?>
</table>
