...
<?php foreach($mctoolstype_list as $key=>$toolstype) { ?>
<tr>
<td><?php echo $toolstype['name']; ?></td>
<td><?php echo $toolstype['price']; ?></td>
<td><?php echo $toolstype['qdprice']; ?></td>
<td><?php echo $toolstype['yqdprice']; ?></td>
<td><?php echo $toolstype['effect']/3600; ?> giờ</td>
<td><?php echo $toolstype['description']; ?></td>
<td><?php echo $toolstype['saleOut'] ? "Đóng" : "Mở"; ?></td>
<td>
<a href="admin.php?mod=mctoolstype_edit&id=<?php echo $key; ?>">Sửa</a>
</td>
</tr>
<?php } ?>
</table>
