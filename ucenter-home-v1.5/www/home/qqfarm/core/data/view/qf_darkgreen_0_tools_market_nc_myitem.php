...
<td><font color=red><?php echo $cropstype[$key]['price']; ?></font> Xu</td>
<td><input type='text' id='number<?php echo $key; ?>' size='10' value="<?php echo $value; ?>"/></td>
<td><input type='text' id='price<?php echo $key; ?>' size='15' value="<?php echo $cropstype[$key]['price']; ?>"/></td>
<td>
<input type="button" onclick='request("tools.php?mod=market&act=nc&type=saleitem&mclass=1&cid=<?php echo $key; ?>&number="+$("#number<?php echo $key; ?>").value+"&price="+$("#price<?php echo $key; ?>").value, "state<?php echo $key; ?>");' value='Bán' /><span id="state<?php echo $key; ?>"></span>
</td>
</tr>
<?php } ?>
...
<td><img src="module/ui/farm/icon/<?php echo $key+30000; ?>.png"/></td> 
<td>-</td>
<td><font color=blue><?php echo $toolstype[30000+$key]['pe']; ?></font> Xu</td>
<td><input type='text' id='number<?php echo 30000+$key; ?>' size='10' value="<?php echo $value; ?>"/></td>
<td><input type='text' id='price<?php echo 30000+$key; ?>' size='15' value="<?php echo $toolstype[30000+$key]['pe']; ?>"/></td>
<td>
<input type="button" onclick='request("tools.php?mod=market&act=nc&type=saleitem&mclass=2&cid=<?php echo $key; ?>&number="+$("#number<?php echo 30000+$key; ?>").value+"&price="+$("#price<?php echo 30000+$key; ?>").value, "state<?php echo 30000+$key; ?>");' value='Bán' /><span id="state<?php echo 30000+$key; ?>"></span>
</td>
</tr>
<?php } ?>
</table>
