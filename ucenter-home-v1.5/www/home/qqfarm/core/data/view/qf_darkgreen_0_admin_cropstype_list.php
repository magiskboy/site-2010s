...
<?php foreach($farm_list as $farmlist) { ?>
<tr>
<td><?php echo $farmlist['cId']; ?></td>
<td><?php echo $farmlist['cName']; ?></td>
<td><?php echo $farmlist['cLevel']; ?></td>
<td><?php echo $farmlist['cropExp']; ?></td>
<td><?php echo $farmlist['expect']; ?></td>
<td><?php echo $farmlist['growthCycle']/3600; ?> giờ</td>
<td><?php echo $farmlist['output']; ?></td>
<td><?php echo $farmlist['maturingTime']; ?></td>
<td><?php echo $farmlist['price']; ?></td>
<td><?php echo $farmlist['sale']; ?></td>
<td>
<a href="admin.php?mod=cropstype_edit&id=<?php echo $farmlist['cId']; ?>">Sửa</a>
</td>
</tr>
<?php } ?>
</table>
