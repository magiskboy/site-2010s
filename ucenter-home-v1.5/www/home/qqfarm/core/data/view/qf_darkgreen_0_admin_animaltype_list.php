...
<?php foreach($animaltype_list as $key=>$animaltype) { ?>
<tr>
<td><?php echo $animaltype['cName']; ?></td>
<td><?php echo $animaltype['cLevel']; ?></td>
<td><?php echo $animaltype['byproductprice']; ?></td>
<td><?php echo $animaltype['harvestpExp']; ?></td>
<td><?php echo $animaltype['harvestbExp']; ?></td>
<td><?php echo $animaltype['output']; ?></td>
<td><?php echo $animaltype['price'] ; ?></td>
<td><?php echo $animaltype['productprice'] ; ?></td>
<td>
<a href="admin.php?mod=animaltype_edit&id=<?php echo $key; ?>">Sửa</a>
</td>
</tr>
<?php } ?>
</table>
