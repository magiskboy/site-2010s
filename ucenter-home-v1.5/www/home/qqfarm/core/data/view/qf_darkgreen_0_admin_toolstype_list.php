...
<?php foreach($toolstype_list as $key=>$toolstype) { ?>
<tr>
<td><?php echo $toolstype['tName']; ?></td>
<td><?php echo $toolstype['price']; ?></td>
<td><?php echo $toolstype['FBPrice']; ?></td>
<td><?php echo $toolstype['YFBPrice']; ?></td>
<td><?php echo $toolstype['effect']/3600; ?> giờ</td>
<td><?php echo $toolstype['depict']; ?></td>
<td><?php echo $toolstype['saleOut'] ? "Đóng" : "Mở"; ?></td>
<td>
<a href="admin.php?mod=toolstype_edit&id=<?php echo $key; ?>">Sửa</a>
</td>
</tr>
<?php } ?>
</table>
