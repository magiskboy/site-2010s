...
<td><?php if($value[mclass] == 1) { ?><font color="#0000ff">Hạt giống</font><?php } elseif( $value[mclass] == 2) { ?><font color="#ff00ff"><b>Vật phẩm</b></font><?php } elseif( $value[mclass] == 3) { ?><font color="#ff0000">Nông sản</font><?php } ?></td>
<td><?php echo $cropstype[$value[cid]]['cName']; ?></td>
<?php if($value[mclass] == 2) { ?><td><img src="module/ui/farm/icon/<?php echo $value[cid]+30000; ?>.png" height="24px"/></td> 
<?php } else { ?><td><img src="module/ui/farm/icon/<?php echo $value[cid]; ?>.png" height="24px"/></td>
<?php } ?>
<td><?php echo $cropstype[$value[cid]]['cLevel']; ?></td>
<?php if($value[mclass] == 3) { ?>
<td><font color=blue><?php echo $cropstype[$value[cid]]['sale']; ?></font> Xu</td>
<?php } elseif( $value[mclass] == 2) { ?>
<td><font color=blue><?php echo $toolstype[$value[cid]+30000]['price']; ?></font> Xu</td>
<?php } else { ?>
<td><font color=blue><?php echo $cropstype[$value[cid]]['price']; ?></font> Xu</td>
<?php } ?>
...
<td><input type="button" onclick='request("tools.php?mod=market&act=nc&type=cancelitem&id=<?php echo $value[id]; ?>", "state<?php echo $value[id]; ?>");' value='Hủy bỏ' /><span id="state<?php echo $value[id]; ?>"></span></td>
<?php } else { ?>
<td><input type="button" onclick='request("tools.php?mod=market&act=nc&type=buyitem&id=<?php echo $value[id]; ?>&number="+$("#number<?php echo $value[id]; ?>").value, "state<?php echo $value[id]; ?>");' value='Mua' /><span id="state<?php echo $value[id]; ?>"></span></td>
<?php } ?>
<?php if($value[mclass] == 3) { ?>
<?php if($cropstype[$value[cid]]['sale']-$value[cprice]<>0) { ?>
<?php if($cropstype[$value[cid]]['sale']-$value[cprice]>0) { ?>
<td>Rẻ hơn <font color="#0000ff"><?php echo $cropstype[$value[cid]]['sale']-$value[cprice]; ?></font> Xu</td> 
<?php } else { ?>
<td>Đắt hơn <font color="#ff0000"><?php echo $value[cprice]-$cropstype[$value[cid]]['sale']; ?></font> Xu</td>
<?php } ?>
<?php } else { ?>
<td><font color="#ff00ff">Cùng giá</font></td> 
<?php } ?>
<?php } elseif( $value[mclass] == 2) { ?>
<?php if($toolstype[$value[cid]+30000]['price']-$value[cprice]<>0) { ?>
<?php if($toolstype[$value[cid]+30000]['price']-$value[cprice]>0) { ?>
<td>Rẻ hơn <font color="#0000ff"><?php echo $toolstype[$value[cid]+30000]['price']-$value[cprice]; ?></font> Xu</td> 
<?php } else { ?>
<td>Đắt hơn <font color="#ff0000"><?php echo $value[cprice]-$toolstype[$value[cid]+30000]['price']; ?></font> Xu</td> 
<?php } ?>
<?php } else { ?>
<td><font color="#ff00ff">Cùng giá</font></td> 
<?php } ?>
<?php } else { ?>
<?php if($cropstype[$value[cid]]['price']-$value[cprice]<>0) { ?>
<?php if($cropstype[$value[cid]]['price']-$value[cprice]>0) { ?>
<td>Rẻ hơn <font color="#0000ff"><?php echo $cropstype[$value[cid]]['price']-$value[cprice]; ?></font> Xu</td> 
<?php } else { ?>
<td>Đắt hơn <font color="#ff0000"><?php echo $value[cprice]-$cropstype[$value[cid]]['price']; ?></font> Xu</td> 
<?php } ?>
<?php } else { ?>
<td><font color="#ff00ff">Cùng giá</font></td> 
<?php } ?>
