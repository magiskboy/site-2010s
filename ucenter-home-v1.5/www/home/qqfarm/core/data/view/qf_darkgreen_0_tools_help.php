...
<div id="main">
<div class="menu">
<?php $active[$type] = ' class="active"'; ?>
<a<?php echo $active[nc]; ?> href="tools.php?mod=help&type=nc">Trồng trọt</a>
<a<?php echo $active[mc]; ?> href="tools.php?mod=help&type=mc">Chăn nuôi</a>
</div>
<div id="help_tabs"></div>
<dl id="help_content"></dl>
</div>
<script type="text/javascript" src="script.php?info_<?php echo $type; ?>&help"></script>
<script type="text/javascript">
generateTabs();
